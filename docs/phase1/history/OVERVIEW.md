...
### 2026-02-24 — Linear 레이어 + LlamaMLP 구현
...
| LlamaMLP (SwiGLU FFN) | ✅ 완료 | `lightvllm/layers/mlp.py` |
...
1. **Attention Backend** — Naive + SDPA Self-Attention, KV Cache
2. **LlamaAttention** — QKV 프로젝션 + RoPE + Attention + Output 통합
